...
const STATUSES = ['New Lead','Sign Up','Contacted','Interested','Not Interested','Session Booked','Later','Applied','Accepted','Approved','Realized'];
const STATUS_COLORS = {
  'New Lead':'#6b7cff','Sign Up':'2750F5','Contacted':'#a78bfa','Interested':'#76f472', 'Not Interested':'#FF0000',
  'Session Booked':'#fb923c','Later':'#98FB98','Applied':'#fbbf24',
  // 'Applied':'#34d399',
  'Accepted':'#22d3ee','Approved':'#4f7cff','Realized':'#22d3a0'
};
const STATUS_CSS = {
  'New Lead':'status-new-lead','Sign Up':'status-sign-up','Contacted':'status-contacted','Interested':'status-interested','Not Interested': 'status-not-interested',
  'Session Booked':'status-session-booked','Later':'status-later','Applied':'status-applied','Accepted':'status-accepted',
  'Approved':'status-approved','Realized':'status-realized'
};
